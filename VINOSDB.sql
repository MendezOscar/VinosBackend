...
CREATE TABLE ACTIVIDADVISITA(
ACTIVIDADVISITA INT PRIMARY KEY,
IDACTIVIDAD INT
)

ALTER TABLE ACTIVIDADVISITA 
   ADD CONSTRAINT FK_ACTIVIDADVISITA
   FOREIGN KEY (IDACTIVIDAD) 
   REFERENCES ACTIVIDADES(IDACTIVIDAD);
   
CREATE TABLE PROVEEDORVISITA(
PROVEEDORVISITA INT PRIMARY KEY,
IDPROVEEDOR INT
)

ALTER TABLE PROVEEDORVISITA 
   ADD CONSTRAINT FK_PROVEEDORVISITA
   FOREIGN KEY (IDPROVEEDOR) 
   REFERENCES PROVEEDOR(IDPROVEEDOR);
